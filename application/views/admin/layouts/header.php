<header class="main-header" style="position: fixed;">
    <a href="<?php echo base_url(); ?>" class="logo">
        <span class="logo-mini">ANTA</span>
        <span class="logo-lg">ANTATEAM</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><?php echo get_current_username(); ?></span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo base_url('/user/edit/'); ?>" class="btn btn-default btn-flat">Tài khoản</a>
                </div>
